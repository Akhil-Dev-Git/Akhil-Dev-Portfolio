...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div
        className={`flex items-center justify-between w-full max-w-5xl px-6 py-3 mx-auto border rounded-full backdrop-blur-md transition-all duration-300 ${
          isScrolled
            ? "bg-glass border-glass-border shadow-[0_4px_30px_rgba(0,0,0,0.1)]"
      ...
      >
        <Link href="#home" className="flex items-center group relative">
          ...
          <div className="relative flex items-center justify-center w-10 h-10 rounded-full border border-glass-border bg-cards/50 backdrop-blur-md group-hover:border-accent/50 transition-all">
